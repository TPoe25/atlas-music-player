export default function LoadingSkeleton() {
  return (
    <div className="flex w-full justify-center">
      <div className="bg-niners-cream dark:bg-niners-graphite w-full max-w-[896px] animate-pulse rounded-lg shadow-[0px_4px_4px_0px_rgba(213,215,216,0.25)]">
        <div className="flex flex-col md:flex-row">
          {/* Left: Currently Playing Skeleton */}
          <div className="space-y-6 p-8 md:w-1/2">
            {/* Cover art */}
            <div className="bg-niners-black/10 dark:bg-niners-mist/10 aspect-square w-full max-w-[280px] rounded-2xl" />
